...
class PlaceOrderBody {
  ...
  // String _size;
  //initialize parameter which he add.
  // all keys here
  ...
  PlaceOrderBody(
      {@required List<Cart> cart,
        ...
        @required double delivery_charge,
        // @required List<String> size_list,
  ...
  PlaceOrderBody.fromJson(Map<String, dynamic> json) {
    ...
    _delivery_charge = json['delivery_charge'];
    ...
    // _sizeList = List<String>.from(json['size_list']);
  ...
  Map<String, dynamic> toJson() {
    ...
    data['delivery_charge'] = this._delivery_charge;
...
class Cart {
  ...
  List<AddOns> _addOns;
  List<int> _addOnQtys;
  List<String> _sizes; // List of sizes
  ...
  Cart(
      ...
      List<AddOns> addOns,
      List<int> addOnQtys,
      List<String> sizes, // List of sizes
      ) {
    this._foodId = foodId;
    ...
    this._sizes = sizes ?? []; // Initialize the list of sizes, defaults to an empty list
  }
  ...
  List<String> get sizes => _sizes; // Getter for sizes
  ...
  Cart.fromJson(Map<String, dynamic> json) {
    ...
    // Initialize the list of sizes from JSON
    if (json['size_list'] != null) {
      _sizes = List<String>.from(json['size_list'].map((x) => x.toString()));
    } else {
      _sizes = []; // Default to an empty list if 'size_list' is not present
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['size_list'] = _sizes; // Add the list of sizes to JSON
    return data;
  }
}
