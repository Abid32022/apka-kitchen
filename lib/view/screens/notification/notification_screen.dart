...
import 'package:Apka_kitchen/view/screens/notification/widget/notification_dialog.dart';
      ...
      body: Get.find<AuthController>().isLoggedIn()
          ? GetBuilder<NotificationController>(
              ...
              if (notificationController.notificationList != null) {
                print("notification are${notificationController.notificationList.length}");
