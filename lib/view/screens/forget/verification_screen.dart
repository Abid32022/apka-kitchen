...
import 'package:Apka_kitchen/view/base/custom_dialog.dart';
              ...
              Padding(
                ...
                child: PinCodeTextField(
                  ...
                  pinTheme: PinTheme(
                    ...
                    selectedColor:
                       Color(0xFF009f67).withOpacity(0.2),
                    ...
                    inactiveColor:
                       Color(0xFF009f67).withOpacity(0.2),
                    activeColor:
                       Color(0xFF009f67).withOpacity(0.4),
                    activeFillColor:
                        Theme.of(context).disabledColor.withOpacity(0.2),
                  ),
                        ...
                        onPressed: _seconds < 1
                            ? () {
                                if (widget.fromSignUp) {
                                  ...
                                  authController.forgetPassword('03176190820')
                                      .then((value) {
                                    if (value.isSuccess) {
                                      _startTimer();
                                      showCustomSnackBar(
