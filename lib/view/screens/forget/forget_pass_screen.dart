...
import 'package:Apka_kitchen/view/screens/auth/widget/code_picker_widget.dart';
  ...
  void _forgetPass(String countryCode) async {
    ...
    if (_phone.isEmpty) {
      ...
      if (fromSocialLogin) {
        ...
        Get.find<AuthController>().forgetPassword('03176190820').then((status) async {
          if (status.isSuccess) {
            Get.toNamed(RouteHelper.getVerificationRoute(_numberController.text, '', RouteHelper.forgotPassword, ''));
          } else {
