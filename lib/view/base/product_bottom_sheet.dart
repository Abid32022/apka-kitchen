...
import 'package:Apka_kitchen/view/base/quantity_button.dart';
...
class ProductBottomSheet extends StatefulWidget {
  ...
  ProductBottomSheet({@required this.product, this.isCampaign = false, this.cart, this.cartIndex, this.inRestaurantPage = false,@required this.deliveryCharges});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: ResponsiveHelper.isMobile(context) ? BorderRadius.vertical(top: Radius.circular(Dimensions.RADIUS_DEFAULT))
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        ...
        CartModel _cartModel = CartModel(
            ...
            productController.quantity, _addOnIdList, _addOnsList, widget.isCampaign, widget.product,widget.deliveryCharges,
            [AppConstants.sizeId]
             // [AppConstants.sizeId]'
          ...
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Padding(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            ...
                            style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color:Color(0xFF009f67)),
                          ),
                        ),
                      ),
                        ...
                        widget.isCampaign ? SizedBox(height: 25) : GetBuilder<WishListController>(builder: (wishList) {
                          return InkWell(
                            ...
                            child: Icon(
                              ...
                              color: wishList.wishProductIdList.contains(widget.product.id) ?Color(0xFF009f67)
                ...
                //               decoration: BoxDecoration(
                //                 color:
                //                 productController.variationIndex[index] != i ? Theme.of(context).backgroundColor :AppColors.primarycolor
                //                 ,borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                //                 border:
                    ...
                    itemBuilder: (context, index) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: productController.addOnActiveList[index] ?Color(0xFF009f67) : Theme.of(context).backgroundColor,
                            borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                ...
                Row(children: [
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL), side: BorderSide(width: 2, color:Color(0xFF009f67)),
                    ),
                    ),
                    onPressed: () {
                      if(widget.inRestaurantPage) {
                    ...
                    child: Image.asset(Images.house, color:AppColors.primarycolor ,height: 30, width: 30),
                  ),
                    ...
                    onPressed: () {
                      ...
                      if(widget.isCampaign) {
                        ...
                        if (Get.find<CartController>().existAnotherRestaurantProduct(_cartModel.product.restaurantId)) {
                          ...
                          Get.find<CartController>().addToCart(deliveryfee:widget.deliveryCharges[0] ,cartModel:_cartModel ,index: widget.cartIndex ,sizes:'12' );
                          _showCartSnackBar(context);
                        }
                      }
                    },
