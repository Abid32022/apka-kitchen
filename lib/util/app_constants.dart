...
class AppConstants {
  static const String APP_NAME = 'Apka Kitchen';
  static const int APP_VERSION = 1;
  static const int SLOT_IN_MINUTE = 30;
  static const int DIGITS_AFTER_POINT = 2;
  static const String BASE_URL = 'https://s3bits.com/apkakitchen';
  // static const String BASE_URL = 'https://s3bits.com/ansaarbazar';
  static const String CATEGORY_URI = '/api/v1/categories';
  static const String BANNER_URI = '/api/v1/banners';
  static const String RESTAURANT_PRODUCT_URI = '/api/v1/products/latest';
  static const String POPULAR_PRODUCT_URI = '/api/v1/products/popular';
  static const String All_PRODUCT_API = '/api/v1/products/get-all-product';

  // https://s3bits.com/ansaarbazar/api/v1/products/popular?limit=200&offset=1
  ...
  static const String PRODUCT_SEARCH_URI1 = '/api/v1/customer/search';
  ...
  static const String sendMessage_URI = '/api/v1/customer/message/send-message';
  static const String getMessageURI = '/api/v1/customer/message/get-message/';
  ...
  static  int productPagination = 1 ;
  static  String userID = '' ;

  static  String sizeId = '';
